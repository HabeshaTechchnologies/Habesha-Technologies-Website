...
!function(t, e) {
    ...
    function p(t) {
        ...
        e) {
            ...
            b = e.body,
            (a = g.createElementNS("http://www.w3.org/2000/svg", "g")).style.transform = "none";
    ...
    var g, y, r, b, c, f, d, a, m, i, w = "transform", k = w + "Origin", C = [], E = [], M = ((i = Matrix2D.prototype).inverse = function inverse() {
        var t = this.a
          , e = this.b
          , i = this.c
          , n = this.d
    ...
    function za(t) {
        if (t !== l) {
            ...
            if (t && (i || n)) {
                ...
                for (; r--; )
                    G[r] ? e[H[r]] = G[r] : e.removeProperty($(H[r]));
                l = t
            }
        }
    }
    function Aa(t, e, r, i) {
        ...
        var a, s, o, l, u, p, h, c, f, n, d, m, g, v, y, x = (r = r || {}).clearProps, b = r.onEnter, w = r.onLeave, S = r.absolute, k = r.absoluteOnLeave, C = r.custom, V = r.delay, E = r.paused, M = r.repeat, B = r.repeatDelay, F = r.yoyo, L = r.toggleClass, I = r.nested, P = r.zIndex, T = r.scale, A = r.fade, O = r.stagger, N = r.spin, D = r.prune, Y = ("props"in r ? r : t).props, z = _(r, rt), R = Q.timeline({
            delay: V,
            paused: E,
            repeat: M,
            repeatDelay: B,
            yoyo: F,
            data: "isFlip"
        }), W = z, j = [], G = [], H = [], q = [], $ = !0 === N ? 1 : N || 0, Z = "function" == typeof N ? N : function() {
            return $
        }
        ...
        m = function run() {
            ...
            l = 0; l < H.length; l++)
                ...
                O && q.push(u)) : 0 < p.sd && A && (u.style.opacity = J ? g.opacity - v.opacity : "0"),
                ot(g, v, T, Y)) : v.isVisible !== g.isVisible && (v.isVisible ? g.isVisible || (v.css = g.css,
                G.push(v),
                H.splice(l--, 1),
                S && I && ot(g, v, T, Y)) : (g.isVisible && j.push(g),
                H.splice(l--, 1))),
                T || (u.style.maxWidth = Math.max(g.width, v.width) + "px",
    ...
    var I, Q, tt, s, o, P, T, l, n, h = 1, F = {}, O = 180 / Math.PI, N = Math.PI / 180, D = {}, Y = {}, et = {}, it = S("onStart,onUpdate,onComplete,onReverseComplete,onInterrupt"), nt = S("transform,transformOrigin,width,height,position,top,left,opacity,zIndex,maxWidth,maxHeight,minWidth,minHeight"), rt = {
        zIndex: 1,
        kill: 1,
        simple: 1,
        spin: 1,
        ...
        getVars: 1,
        props: 1
    }, st = {}, R = "paddingTop,paddingRight,paddingBottom,paddingLeft,gridArea,transition".split(","), j = function _parseElementState(t, e, i, n) {
        ...
        a.height = x)),
        a || d
    }, G = [], H = "width,height,overflowX,overflowY".split(","), lt = function _killFlip(t, e, i) {
    ...
    n.compare = function compare(t) {
        ...
        for (n in u)
            ...
            m.push(o.element, l.element)) : jh(o, l, o.element),
            a && o.element === a.element && (a = u[n]),
            kh(o.element !== i.element && a ? a : o, i, i.element),
            kh(a && a.element === s.element ? a : o, s, s.element),
            a && kh(a, s.element === a.element ? s : i, a.element)) : (i ? i.isDifferent(e) ? jh(e, i, r) : h.push(r) : f.push(r),
            a && kh(a, i, a.element));
        for (n in p)
