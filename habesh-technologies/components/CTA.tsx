  ...
  return (
    <div>
      ...
      <div className="tp-cta-area tp-bg-common-green-3 pt-180 pb-170 p-relative z-index-1 fix section-m-spacing">
        {/* Shape elements remain the same */}
        <div
          className="mil-scale-img tp-cta-it-scale h-100"
          data-value-1="1.45"
          data-value-2="1"
        >
          {" "}
          <img
            className="tp-cta-it-shape"
            src="assets/img/cta/shape.png"
            alt=""
          />{" "}
          <img
            className="tp-cta-it-shape-2"
          ...
          <div className="row justify-content-center">
            <div className="col-lg-12">
              ...
              <div className="tp-cta-it-content text-center">
                <h2 className="tp-ff-inter fw-600 fs-36 ls-m-4 tp-text-common-black-1 mb-30">
                  Ready to Start Your Digital Project?
                </h2>
                {/* --- CHANGED: Replaced Form with a Single Button CTA --- */} 
                <div className="tp-cta-it-form">
                  {" "}
                  <a
                    href="/contact"
                    className="tp-btn-it-xl mb-30 fw-700 fs-16 ls-m-3 text-uppercase tp-text-grey-5 tp-ff-inter tp-bg-common-black-1 tp-round-10"
                  >
                    Discuss Your Project{" "}
                  </a>
                </div>{" "}
                <br />
                {/* --- CHANGED: New Call-to-Action Text --- */}
                <p className="tp-cta-it-trams tp-ff-inter fw-400 fs-18 ls-m-4 tp-text-common-black-1">
                  {" "}
                  <span className="d-inline-block mr-5">
                    {/* Reused the existing icon (can be replaced with a phone or chat icon if desired) */}
                    <svg
                      width="30"
                      height="30"
                      viewBox="0 0 30 30"
