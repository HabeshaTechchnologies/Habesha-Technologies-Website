...
const BlogFirstSection = (props: Props) => {
  return (
    <div>
          ...
          <div className="row pb-45">
            <div className="col-lg-7">
              <div className="tp-service-hero-left p-relative z-index-1 mb-40">
                <h2 className="fs-70 fs-lg-60 fs-xs-40">
                  Latest News &<br /> Insights.
                </h2>
                <div className="tp-service-details-icon">
                  <img
                    className="tp-live-anim-spin"
                    src="assets/img/breadcrumb/icon.png"
                    alt=""
                  />
                </div>
            ...
            <div className="col-lg-5">
              <div className="tp-service-hero-right mt-135">
                <p className="fs-20 lh-140-per">
                  At <strong>Habesha Technologies</strong>, we go beyond
                  building websites— we deliver powerful digital solutions that
                  drive growth. Our team specializes in <br />
                  web and software development, UI/UX design, and digital
                  strategy, helping businesses turn ideas into scalable,
